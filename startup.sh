...
show_status() {
    ...
    echo "📧 soporte@crm.com    (password: Temporal123! | role: soporte — Carlos Mendoza)"
    echo "📧 soporte2@crm.com   (password: Temporal123! | role: soporte — Laura Garcia)"
    echo "📧 comercial@crm.com  (password: Temporal123! | role: comercial — Ana Rodriguez)"
    echo "📧 comercial2@crm.com (password: Temporal123! | role: comercial — Martin Lopez)"
    echo ""
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo -e "${BLUE}🏢 SEED CLIENTS (only in Artemisa)${NC}"
    echo -e "${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo "🏢 Burger House           (gerencia@burgerhouse.com    | active)"
    echo "🏢 Cafe de Origen         (ventas@cafedeorigen.com     | active)"
    echo "🏢 Didi Food MX           (restaurantes@didifood.com   | active)"
    echo "🏢 NU Bank                (empresas@nu.com.mx          | active)"
    echo "🏢 Pizza Tradizionale     (contacto@pizzatradizionale.com | active)"
    echo "🏢 Sushi Express          (contacto@sushiexpress.com   | active)"
    echo "🏢 Tacos El Pastor        (info@tacoselpastor.com      | inactive)"
    echo "🏢 Wok & Roll             (contacto@wokandroll.com     | active)"
    echo ""
